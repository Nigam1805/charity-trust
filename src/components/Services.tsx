...
import { Heart, UtensilsCrossed, Users, Package, type LucideIcon } from "lucide-react";
  ...
  return (
    <section id="services" className="py-16 md:py-20">
      <div className="container mx-auto px-4">
        ...
        >
          We reach the needy through hospitals, schools, ashrams, and communities.
        </motion.p>
        <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {services.map((service, index) => {
            const Icon = iconMap[service.icon] ?? Package;
            const svc = service as { id: string; icon: string; title: string; description: string; imagePlaceholder: string; localImage?: string };
